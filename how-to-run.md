...
1. Install original Jagged Alliance 2 game on your computer.  Data files from the original game will be used by JA2 Stracciatella. If you're installing the Linux port and haven't made a full install, make sure to copy over files from CD2 too.
